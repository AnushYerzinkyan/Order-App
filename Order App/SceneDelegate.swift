    ...
    func scene(
        ...
        guard
            let restorationController =
                NSUserActivity.StateRestorationController(userActivity: stateRestorationActivity),
        ...
        case .menu(let category):
            ...
            restorationController.identifier.rawValue, creator: { (coder) in
        ...
        case .menuItemDetail(let menuItem):
            let menuTableViewController =
            storyboard.instantiateViewController(identifier:
            NSUserActivity.StateRestorationController.Identifier.menu.rawValue,
            creator: { (coder) in
